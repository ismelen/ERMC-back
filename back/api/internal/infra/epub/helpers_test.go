...
func getFakePages(t *testing.T, tmpDir string, numPages int) []*manga.Page {
	...
	var fakeJPEG = []byte{
		...
		0x00, 0x08, 0x01, 0x01, 0x00, 0x00, 0x3f, 0x00, 0xfd, 0xfc, 0xff, 0xd9,
	}

	for i := range numPages {
		imgPath := filepath.Join(chaptersDir, fmt.Sprintf("page%04d.jpg", i+1))
		err := os.WriteFile(imgPath, fakeJPEG, os.ModePerm)
